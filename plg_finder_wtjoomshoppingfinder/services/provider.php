...
/**
 * Service provider for the WT JoomShopping Finder plugin.
 *
...
return new class () implements ServiceProviderInterface {
	/**
	 * Registers the Finder plugin instance in Joomla's service container.
	 *
	...
	public function register(Container $container): void
	{
		$container->set(
			...
			$container->lazy(Wtjoomshoppingfinder::class, static function (Container $container): PluginInterface {
